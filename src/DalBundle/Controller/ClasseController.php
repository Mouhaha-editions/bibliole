...
class ClasseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $classes = $em->getRepository('DalBundle:Classe')->findAll();
    ...
    {
        $classe = new Classe();
        $form = $this->createForm('DalBundle\Form\ClasseType', $classe);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_classe_show', array('id' => $classe->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($classe);
        $editForm = $this->createForm('DalBundle\Form\ClasseType', $classe);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('admin_classe_edit', array('id' => $classe->getId()));
        }
